import Horizon1 from "@/app/components/horizon1";
  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div
            ...
            <iframe width="100%" height="100%" className="absolute inset-0" frame-border="0" title="map" margin-height="0"
                margin-width="0" scrolling="no"
        ...
        <div className="lg:w-1/3 md:w-1/2  flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 p-4 bg-black border border-gray-800">
